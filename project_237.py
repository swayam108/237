    ...
    for detection in point_cloud_data:
        ...
        if distance_name_data['name'] == 'Vehicles':
            ...
            if prediction == 1:
                ...
                print("car will be moving in reverse direction and reverse lights are getting ON when the distance is less than 17")
                break
                ...
                print("when the distance is more than 17 the car is moving forward and the beam lights are getting flashed ON")
                break
